...
@section('content')
    <div class="min-h-screen bg-gray-50 text-gray-900 font-sans">
                ...
                <div class="flex items-center gap-8">
                    ...
                    <div x-data="{ open: false }" @mouseover.away="open = false" class="relative">
                        <button @mouseover="open = true" type="button"
                            ...
                            <span class="ml-2 mr-1 text-sm font-semibold text-gray-700 hidden sm:inline">
                                {{ session('usuario_nombre') ?? 'Usuario' }}
                            </span>
                            <svg class="w-4 h-4 ml-1 text-gray-400 transition-transform" :class="{ 'rotate-180': open }"
        ...
        <main class="max-w-7xl mx-auto px-6 py-16">
            ...
            {{-- Tarjeta de saldo --}}
            <div
                class="bg-gradient-to-br from-blue-600 to-cyan-700 rounded-3xl p-10 text-white mb-20 shadow-xl shadow-blue-200 transform hover:scale-[1.01] transition-transform duration-300">
                ...
                <p class="text-7xl font-bold mb-10">${{ number_format($saldo_real, 2) }}</p>
                ...
                <div class="flex gap-12 border-t border-white/50 pt-6">
                    <div class="flex-1">
                        ...
                        <p class="text-2xl font-semibold text-green-200">+$5,000.00</p> {{-- Valor fijo --}}
                    </div>
                    <div class="flex-1">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <a href="{{ route('users.account') }}"
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <svg class="w-7 h-7 text-gray-400 group-hover:text-blue-600 transition" fill="none"
